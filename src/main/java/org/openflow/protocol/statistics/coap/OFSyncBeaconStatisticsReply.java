...
/**
 * Represents an ofp_syncbeacon_stats_reply structure
 * @author Ashish Patro (patro@cs.wisc.edu)
 */
public class OFSyncBeaconStatisticsReply implements OFStatistics {
    protected String ap; /* Identifier for the AP */
    protected int timestamp;  /* unix timestamp in seconds */
    protected short seq;    /* Sequence number of the current beacon */
	...
	public void writeTo(ChannelBuffer data) {
    	...
    	data.writeShort(this.seq);
    	data.writeShort(this.channel);
	}
	
	@Override
	public String toString() {
		return "OFSyncBeaconStatisticsReply [ap=" + ap + ", timestamp="
				+ timestamp + ", seq=" + seq + ", channel=" + channel + "]";
	}
    ...
    public int hashCode() {
        ...
        result = prime * result + (this.seq ^ (this.seq >>> 32));
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof OFSyncBeaconStatisticsReply)) {
            return false;
        }
        
        OFSyncBeaconStatisticsReply other = (OFSyncBeaconStatisticsReply) obj;
