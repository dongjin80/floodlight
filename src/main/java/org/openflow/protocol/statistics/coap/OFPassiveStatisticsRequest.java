 ...
 */
public class OFPassiveStatisticsRequest implements OFStatistics {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof OFPassiveStatisticsRequest)) {
            return false;
        }
        OFPassiveStatisticsRequest other = (OFPassiveStatisticsRequest) obj;
