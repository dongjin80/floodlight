...
import org.openflow.protocol.statistics.coap.OFSyncBeaconStatisticsReply;
...
public enum OFStatisticsType {
    ...
    APINFO      (6, OFApinfoStatisticsRequest.class, OFApinfoStatisticsReply.class,
		        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
		                return new OFApinfoStatisticsRequest();
		            }
		        },
		        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
		                return new OFApinfoStatisticsReply();
		            }
		        }),
            		        
    UTIL      (7, OFUtilStatisticsRequest.class, OFUtilStatisticsReply.class,
		        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
    ...
    STATION   (8, OFStationStatisticsRequest.class, OFStationStatisticsReply.class,
		        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
		                return new OFStationStatisticsRequest();
		            }
		        },
		        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
		                return new OFStationStatisticsReply();
		            }
		        }),
        
 SYNCBEACON   (9, OFSyncBeaconStatisticsRequest.class, OFSyncBeaconStatisticsReply.class,
		        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
		                return new OFSyncBeaconStatisticsRequest();
		            }
		        },
		        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
		                return new OFSyncBeaconStatisticsReply();
		            }
		        }),

   NONWIFI   (10, OFNonWiFiStatisticsRequest.class, OFNonWiFiStatisticsReply.class,
	 	        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
   	 ...
   	 BEACON   (11, OFBeaconStatisticsRequest.class, OFBeaconStatisticsReply.class,
	 	        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
		                return new OFBeaconStatisticsRequest();
		            }
		        },
		        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
		                return new OFBeaconStatisticsReply();
		            }
		        }),
		        
 	 CLIENT   (12, OFClientStatisticsRequest.class, OFClientStatisticsReply.class,
		        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
	 ...
	 PASSIVE   (13, OFPassiveStatisticsRequest.class, OFPassiveStatisticsReply.class,
		        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
		                return new OFPassiveStatisticsRequest();
		            }
		        },
		        new Instantiable<OFStatistics>() {
		            @Override
		            public OFStatistics instantiate() {
		                return new OFPassiveStatisticsReply();
		            }
		        }),
		 		        
 TRAFFICINFO   (14, OFTrafficinfoStatisticsRequest.class, OFTrafficinfoStatisticsReply.class,
			        new Instantiable<OFStatistics>() {
			        @Override
			        public OFStatistics instantiate() {
			            return new OFTrafficinfoStatisticsRequest();
			        }
			    },
			    new Instantiable<OFStatistics>() {
			        @Override
			        public OFStatistics instantiate() {
			            return new OFTrafficinfoStatisticsReply();
			        }
			    }),	

DIAGNOSTICINFO  (15, OFDiagnosticinfoStatisticsRequest.class, OFDiagnosticinfoStatisticsReply.class,
			        new Instantiable<OFStatistics>() {
			        @Override
			        public OFStatistics instantiate() {
			            return new OFDiagnosticinfoStatisticsRequest();
			        }
			    },
			    new Instantiable<OFStatistics>() {
			        @Override
			        public OFStatistics instantiate() {
			            return new OFDiagnosticinfoStatisticsReply();
			        }
			    }),	
